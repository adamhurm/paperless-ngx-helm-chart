...
[here](https://github.com/gabe565/charts/issues/new?assignees=gabe565&labels=bug&template=bug_report.yaml&name=smarter-device-manager&version=0.5.2)**
...
```console
helm install smarter-device-manager oci://ghcr.io/gabe565/charts/smarter-device-manager
```
